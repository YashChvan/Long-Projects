...
public class WordNet {
    ...
    private ST<Integer, String> nouns_id;
    ...
    private void readSynsets(String synsets) {
        ...
        nouns_id = new ST<Integer, String>();
    ...
    // build Digraph wordnet
    private void readHypernyms(String hypernyms) {
        this.wordnet = new Digraph(idSum);
